...
def test(model: nn.Module, test_loader, device: torch.device, checkpoint_path: str, output_dir: str) -> None:
    ...
    metrics_data = {
        'Metric': ['Accuracy', 'Precision', 'Recall', 'F1 Score', 'Matthews Corr. Coeff.'],
