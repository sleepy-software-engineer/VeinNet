...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[
        ...
        sigmoid/.style={draw, minimum width=1.5cm, minimum height=0.8cm, rounded corners, fill=blue!10},
        input/.style={font=\large},
    ...
    \node[relu, below=of conv4] (relu4) {ReLU};
    \node[linear, below=of relu4] (linear1) {Linear \\ Flatten $32*32*32 \to $128};
    \node[linear, below=of linear1] (fc_image) {FC Image};
    ...
    \node[linear, below=of linear2, yshift=-0.5cm] (fc_final) {FC Fina};
    \node[output, below=of fc_final, yshift=-0.5cm] (output) {Output \\ Class Predictions};
